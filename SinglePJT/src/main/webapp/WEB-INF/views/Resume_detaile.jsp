...
<%@include file="header.jsp"%>
   ...
   <p style="margin-bottom: 0px;">□ 인적사항</p>
       <div  style="width:120px; height:150px; border:1px solid black; float:left; align-items: center;  margin-right: 3%; padding-left:2px; " id="img">
         ...
         <br><br><br>
         <div class="row">
	         <div class="col-md-2 mt-1" style="margin: 0 2% 0 24%;"><input type="button" class="form-control" value="돌아가기" onclick="location.href='/main/resume_list'"></div>
	         <div class="col-md-2 mt-1" ><input type="button" name="addResume" class="form-control" id="log" value="공고제의" onclick="modify()"></div>
         </div>
         <br>
      </div>
